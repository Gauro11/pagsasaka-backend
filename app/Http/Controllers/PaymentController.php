...
public function payment(Request $request)
{
    ...
    try {
        ...
        // 👇 Generate a unique order number shared across all items in this checkout
        ...
        foreach ($ordersData as $orderData) {
            Order::create([
                ...
                'order_number' => $orderNumber, // ✅ included here
            ]);
        }
        ...
        return response()->json([
            ...
            'total_amount' => number_format($totalAmount, 2, '.', ''),
            'full_name' => $fullName,
            'order_number' => $orderNumber, // Optional: return it to frontend too
        ]);
    } catch (Exception $e) {
        DB::rollBack();
